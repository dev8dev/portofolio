<div class="col-12 grid-margin stretch-card">
    <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form Input Data - Berita</h4>
                        <div class="table-responsive">
                        <div align="right"><a class="btn btn-dark btn-rounded btn-fw" href="{{route('berita.create')}}"><i class="icon icon-plus mr-2"></i>Input Data</a></div>
                        </div>
                            <hr>
                            <div class="table-responsive">
                                <table id="t_berita" class="table table-bordered table-condensed table-striped">
                                    <thead>
                                        <tr bgcolor="#c7c6c1">
                                            <th width="200"><b>Judul</th>  
                                            <th width="100"><b>Tgl Terbit</th>
                                            <th width="100"><b>Image</th>
                                            <th width="250"><b>Description</th>
                                            <th width="150"><b>Action</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
...
<script type="text/javascript">
    ...
    // Print functionality (uncomment jika diperlukan)
    /*
    $('#printTable').on('click', function() {
        var tableContent = $('#t_berita').clone();
        ...
        newWindow.document.write('<h3>Data Berita</h3>');
